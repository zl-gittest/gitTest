 ...
 */
@MultipartConfig()
@WebServlet("/universalTextTaxiReceipt")
public class universalTextTaxiReceipt extends HttpServlet{
    private static final long serialVersionUID = 1L;
    @Override
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        req.setCharacterEncoding("utf-8");
        resp.setContentType("text/html;charset=utf-8");
        Part huantu = req.getPart("huantu5");
        ...
        JSONObject jsonObject = PictureFormatChange.universalTextTaxiReceipt(aipOcr, path);
